    ...
    <div className="welcome">
      <div className="intro">
        ...
        <p className="intro-text">
          My Name is Justin Praßl and I'm a 25 years old software developer from Germany. <br />
      ...
      <div className="misc">
        <ul className="skills">
          ...
          <li className="skills-item">JavaScript (NodeJS, React, Next, Svelte, UI5), TypeScript & PHP</li>
